...
import 'package:cap_mobile/core/apiswap/produit/reserve/data/reserve_test_data.dart';
...
class ReserveProduitPage extends StatefulWidget {
  ...
  const ReserveProduitPage({super.key, required this.product});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                if (leading != null) ...[leading!, SizedBox(width: dp(8))],
                Expanded(
                  child: Text(
                    title,
                ...
                if (trailing != null) ...[SizedBox(width: dp(6)), trailing!],
              ],
            ),
          ),
          Padding(
...
class _SkuChip extends StatelessWidget {
  ...
  const _SkuChip({required this.dp, required this.sp, required this.label});
